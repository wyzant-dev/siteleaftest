...
post-description: This is the meta description and the blog description that will
  appear on the homepage of wyzant. If this doesn't exist, we'll just use the first
  150 characters of the blog.
