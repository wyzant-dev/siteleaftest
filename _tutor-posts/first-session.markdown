...
* Adjust each evaluation to the specific student's needs and your mutual availability. 
* Conduct it in advance over the phone, via messaging, as a free first session, or as an introductory discussion before getting started. You can also use the Online Demo feature in messaging to schedule a meet and greet in the Wyzant tool.

![img-blog-online-demo.gif](/blog/uploads/img-blog-online-demo.gif)
 
* Assessments will vary by age and subject, but often include some combination of the following:
